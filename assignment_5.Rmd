...
There is not a significant association between forest condition (old-growth or clear-cut) and where salamanders are most often observed in the creek channel. Counts and proportions (Table 1) differ between channel type and forest section significantly ($\chi$^2^(2) = `r round(salamander_2017_chi$statistic, 2)`, *p* = `r round(salamander_2017_chi$p.value, 2)`). Majority of salamanders are found in the "cascade" channel type regardless of whether it's located in a clear-cut or old-growth section of the forest. 
