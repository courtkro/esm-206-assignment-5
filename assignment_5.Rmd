...
>>>>>>> c1f0ab08c71ef2d8a111f0f22c92b2b960bed70e
...
<<<<<<< HEAD
Data for Pacific Giant Salamander abundance, weight and location from 1993-2017 was collected by [Stanley V. Gregory](https://portal.edirepository.org/nis/mapbrowse?scope=knb-lter-and&identifier=4027&revision=12). Salamander counts (individuals) were based on the number of observations made in each forest section every year. Each salamander captured at Mack creek and was measured and weighed. Salamanders were observed in three different channel types “pool”, “cascade”, “side-channel” in two types of sections “clear cut” and “old growth”. Trends in salamander abundance and weight in different forest conditions were compared by two-sample t-tests ($\alpha$ = 0.05). Salamander weight in different channel locations were compared using one-way anova tests ($\alpha$ = 0.05). All analyses and figures were developed through R software version 1.2.1335.
=======
